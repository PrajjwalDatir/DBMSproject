...
<?php
$cid=intval($_GET['id']);
$sql=mysqli_query($con,"select course.courseName as courname,course.courseCode as ccode,course.courseUnit as cunit,
session.session as session,department.department as dept,level.level as level,
courseenrolls.enrollDate as edate,semester.semester as sem ,students.studentName as studentname,
students.studentPhoto as photo,students.cgpa as scgpa,students.creationdate as studentregdate 
...
join semester on semester.id=courseenrolls.semester where courseenrolls.studentRegno='".$_SESSION['login']."' and courseenrolls.course='$cid'");
$cnt=1;
